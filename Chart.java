...
public class Chart extends ApplicationFrame{
	...
	static int baseline;
	static String title;
public Chart(String paramString,int k,int b){
	super(paramString);
	knn = k;
	baseline = b;
...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(knn,"KNN","KNN");
	localDefaultCategoryDataset.addValue(baseline,"Baseline","Baseline");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Algorithm", "Index Size", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
